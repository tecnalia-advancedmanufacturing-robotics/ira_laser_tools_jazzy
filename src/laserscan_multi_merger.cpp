  ...
  : Node("laser_multi_merger")
{
  ...
  cloud_destination_topic = this->declare_parameter<std::string>("cloud_destination_topic", "/merged_cloud");
  scan_destination_topic = this->declare_parameter<std::string>("scan_destination_topic", "/merged_scan");
